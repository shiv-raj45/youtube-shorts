...
import { ThumbUpAltOutlined, ThumbDownAltOutlined, MoreHorizOutlined, CommentOutlined, ShareOutlined, ReplyOutlined, MoreHoriz, ThumbUpAlt, ThumbDownAlt, Comment } from '@material-ui/icons'
function Sidebar({likes,comments,setVids,vids,vid}) {
